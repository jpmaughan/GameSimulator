...
class PlayerTwo(pygame.sprite.Sprite, dx, dy, decision):
...
# =============================================================================
    ...
    def __init__(self):
        ...
        # add the decision movements
        self.dx = dx
        self.dy = dy
        self.decision = 'kick' #decision
    ...
    def update(self, ball):
        ...
        # add this later - just get movement for now
        #if pressed_keys[K_SPACE]:
        #    self.decision = 'kick'
...
class Game(DeepPlayer):
    ...
    def __init__(self):
        ...
        self.ball = Ball()
        self.player1 = Player()
        self.player2 = DeepPlayer #PlayerTwo()
    ...
    def run(self):
        ...
        while running:
            ...
            # add the game counter to the system
            game_counter += 1
...
while game_counter < 10:
    ...
    # Add the player to learn
    DeepAttacker = PlayerTwo()
    
    # set the game
    Game().run(DeepAttacker)
    
    
mport random
from IPython.display import clear_output

# set the null movement space
...
# Have two rewards - one for attack one for defence but one at a time
# 
# 
# 
# 
